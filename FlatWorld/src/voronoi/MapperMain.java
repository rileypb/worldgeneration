...
public class MapperMain {
	...
	public static final double SEALEVEL = 0.25;
	...
	public static void main(String[] args) {
		...
		TerrainBuilder builder = new TerrainBuilder(16000, TerrainBuilder.CellType.VORONOI);
		...
		calmPerlin.setFrequency(0.25);
		calmPerlin.setOctaveCount(1);
		calmPerlin.setSeed(r.nextInt());
		Perlin wildPerlin = new Perlin();
		wildPerlin.setFrequency(1);
		wildPerlin.setOctaveCount(1);
